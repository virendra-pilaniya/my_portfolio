...
export const Bio = {
  ...
  description:
    "Full-Stack Engineer with 3+ years of experience building and scaling consumer products at Dream11 for 100M+ users. Led high-impact features across frontend and backend — distributed services, low-latency data platforms, and AI-driven user experiences. IIT (BHU) graduate and Codeforces Expert with a strong foundation in DSA and system design.",
  github: "https://github.com/virendra-pilaniya",
  resume:
    "https://drive.google.com/file/d/1oudMeiRWCkOyI2noeYJSVd9gDrf-koyb/view?usp=sharing",
...
export const experiences = [
  {
    id: 0,
    img: "https://cdn.aptoide.com/imgs/7/f/2/7f29308e2a3adeaec246a8000cab57a6_icon.png",
    role: "Full-Stack Developer",
    company: "Dream11",
    date: "July 2024 - Present",
    desc: "Led end-to-end development of AI Team Packs powering 15% of contest joins for 100M+ users. Built a distributed Club Leaderboard system supporting 50K+ clubs with low-latency reads via DynamoDB and Apache Spark. Architected Second Innings driving 6M+ contest joins, and scaled club-native engagement to 100K+ contest joins. Cut PR review cycle time by 15% with automated quality gates.",
    skills: [
      "React",
      "TypeScript",
      "Redux",
  ...
  },
  {
    ...
    desc: "Migrated shipment services from a monolith to microservices, cutting processing time by 40% for large-scale operations. Built a dynamic supply dashboard and enhanced the sales CRM in React, integrating real-time shipment tracking, quotation entries, and automated supplier preference updates.",
    skills: [
      "Django",
      "React",
      "Python",
